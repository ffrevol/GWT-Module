...
public class Provisioning_moduleGwtTest  extends GWTTestCase  {
	...
	private ProvisioningServiceAsync provService;
	 /**
	  ...
	  public void testLog()
	  {
		  ...
		  logger.info("info : test will failed");
		  logger.fine("fine : test will failed");
		  logger.finest("finest : test will failed");
		  assertTrue("OK", true);
	  }
